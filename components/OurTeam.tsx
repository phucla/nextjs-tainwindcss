    ...
    <div className="container">
      ...
      <div className="flex flex-wrap">	
        {data.map(item => (
          ...
          <div className="cursor-pointer py-6 px-10 border border-gray-100 border-solid hover:shadow-custom duration-500 transition-shadow group transform my-3" data-wow-duration="2s" data-wow-delay="0.4s" data-wow-offset="0">
